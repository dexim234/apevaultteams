...
export const DayStatusForm = ({ type, status, onClose, onSave }: DayStatusFormProps) => {
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/70 backdrop-blur-md flex items-start sm:items-center justify-center z-50 p-3 sm:p-4 overflow-y-auto touch-manipulation">
      <div className={`w-full max-w-md rounded-2xl shadow-2xl border ${theme === 'dark' ? 'bg-gradient-to-br from-[#0f1625] via-[#0d1220] to-[#0b101c] border-white/10' : 'bg-gradient-to-br from-white via-slate-50 to-white border-slate-200'} max-h-[90vh] overflow-y-auto my-4 sm:my-8`}>
        <div className="p-4 sm:p-6">
          <div className="flex items-center justify-between mb-5 sm:mb-6">
            <div className="space-y-1">
              <p className="text-xs uppercase tracking-[0.18em] text-[#4E6E49] font-semibold">Статус дня</p>
