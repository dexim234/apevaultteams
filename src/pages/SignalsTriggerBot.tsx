...
import { TriggerAlert, AiAoStrategy } from '@/types'
...
const STRATEGIES: AiAoStrategy[] = ['Фиба', 'Market Entry']
...
export const SignalsTriggerBot = () => {
    ...
    const getStrategyColor = (strategy: AiAoStrategy) => {
        switch (strategy) {
...
interface MultiStrategySelectorProps {
    value: AiAoStrategy[]
    onChange: (strategies: AiAoStrategy[]) => void
    theme: string
}
